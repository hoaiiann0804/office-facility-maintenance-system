        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchasedDated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceTickets_Equipment_EquipmentId",
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceTickets_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketStatusHistories_MaintenanceTickets_MaintenanceTicketId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceTickets_CreatedByUserId",
                table: "MaintenanceTickets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketStatusHistories_MaintenanceTicketId",
                table: "TicketStatusHistories",
